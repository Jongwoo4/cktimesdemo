...
const NewsCategoryPage = ({ params }: { params: any }) => {
    ...
    useEffect(() => {
      ...
      const fetchArticles = async () => {
        try {        
          ...
          const response = await fetch(DJANGO_BASE_URL + '/articles/category/' + category + '/?page=' + page);
    ...
    return ( 
        <div className='col-span-2'>
            <h1 className='text-lg font-bold border-b-4 border-orange-300 pt-6 pb-4 pl-2'> {category} </h1>
